...
from run_mcts_multiple_actions.mcts_generator import mcts_generation
# from run_mcts_multiple_actions.mcts_discriminator import mcts_discrimination
...
if __name__ == "__main__":
    ...
    # python run_mcts_multiple_actions/run_framework.py
    # accelerate launch --multi_gpu run_mcts_multiple_actions/run_framework.py
