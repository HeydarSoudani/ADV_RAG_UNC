...
def mcts_evaluation(args):
    ...
    evaluate_results_file = f"{args.output_dir}/{model_}/{args.dataset}_{args.subsec}/evaluate_results.jsonl"
    ...
    with open(discriminate_results_file, 'r') as infile:
        for line in infile:
    ...
    with open(evaluate_results_file, 'w') as file:
