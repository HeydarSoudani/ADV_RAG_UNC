...
# Based on rStar code and Rasbery
class ReasoningConsistency(BasicDiscriminator): # Adopted for RAG
    ...
    def _filter_reasoning_consistency(self, question: str, candidates: list[Candidate], aux={}) -> list[Candidate]:
        ...
        answer_list = [self.get_answer_searchr1(completion) for completion in completion_list]
        count = 0
